...
class AppTheme {
  ...
  static final ThemeData darkTheme = _buildTheme(
    colorScheme: ColorScheme.fromSeed(
      seedColor: const Color(0xFFFFFC00),
      brightness: Brightness.dark,
      surface: const Color(0xFF000000),
      onSurface: Colors.white,
      primary: const Color(0xFFFFFC00),
      onPrimary: Colors.black,
      secondary: const Color(0xFF00C8FF),
    ...
    appColors: const AppColorsExtension(
      ...
      snapYellow: Color(0xFFFFFC00),
      onlineGreen: Color(0xFF2ED573),
      storyRing: Color(0xFF00C8FF),
      storyRingSeen: Color(0xFF3A3A3C),
      chatBubbleSelf: Color(0xFF0A84FF),
